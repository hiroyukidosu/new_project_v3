...
class AppDimensions {
  ...
  // テキストフィールド設定
  static const int memoMaxLines = 4;
  static const int medicationNameMaxLines = 1;
  static const int dosageMaxLines = 1;
  
  // リスト設定
  static const double medicationListHeight = 250.0;
  static const double expandedListHeight = 500.0;
  
  // カレンダー設定
  static const double calendarHeight = 400.0;
  static const double calendarItemHeight = 50.0;
